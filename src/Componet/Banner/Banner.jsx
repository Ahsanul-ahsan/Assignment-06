...
const Banner = () => {
    return (
        ...
        <div className='max-w-11/12 mx-auto flex justify-between items-center mb-8'>
            <div className=' space-y-2 text-left'>
                ...
                <h1 className='font-bold text-3xl'>Supercharge Your <br /> Digital Workflow</h1>
            ...
            <div>
                <img className='w-100 h-100' src={bannerlogo} alt="" />
            </div>
